...
export default async function getPageProperties(
  ...
  // console.log(' 1111.type', properties)
  // console.log(' 222properties.type', properties.type)

  // type\status\category It is a single-select drop-down box. Take the first one in the array.
  properties.type = properties.type?.[0] || ''
  // console.log(' 33properties.type', properties.type)
  ...
  if (isAbleType) {
    ...
    // console.log('이제 properties.slug::', properties.slug)
...
function mapProperties(properties) {
  ...
  if (properties?.type === BLOG.NOTION_PROPERTY_NAME.type_read) {
    properties.type = 'Read'
  }
  if (properties?.type === BLOG.NOTION_PROPERTY_NAME.type_portfolio) {
    properties.type = 'Portfolio'
  }
  ...
  if (properties?.type === BLOG.NOTION_PROPERTY_NAME.type_alawgblog) {
    properties.type = 'Alawgblog'
  }
