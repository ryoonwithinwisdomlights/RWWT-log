...
export const NavBar = props => {
  ...
  return (
    <nav className="w-full bg-white md:pt-0  relative z-20 shadow border-t border-gray-100 dark:border-hexo-black-gray dark:bg-neutral-900 ">
      <div
        id="nav-bar-inner"
      ...
      >
        ...
        <div className="absolute right-12 h-full text-center px-2 flex items-center text-lime-400  cursor-pointer">
          {/* <!-- extra links --> */}
          <i
            className={
              showSearchInput
