...
export default function OmniDocItem({ sub_type, omniDocPosts, docsSubType }) {
  //   if (docsSubType !== 'All') {
  //     omniDocPosts = omniDocPosts[docsSubType]
  //   }
  console.log('omniDocPosts::::', omniDocPosts)
  console.log('sub_type::::', sub_type)
  return (
    <div key={sub_type}>
      <div id={sub_type} className=" pb-4 text-2xl dark:text-neutral-300">
        {sub_type}
      </div>
      <ul>
        {omniDocPosts[sub_type]?.map(post => (
          <li
            key={post.id}
